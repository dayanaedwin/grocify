    ...
    return (
        <div className='flex min-h-screen'>
            ...
            <div className='flex-1 flex flex-col justify-center items-center p-6 md:p-12'>
                <Heading level={2} className='text-3xl font-bold mb-6 text-gray-500'>Welcome to grocify</Heading>
                <form className='w-full max-w-sm space-y-4' onSubmit={handleSubmit(onSubmit)}>
                    <div>
                        <Heading level={1} color='secondary' className='block text-sm font-medium text-gray-700'>Name</Heading>
                        <input
                            {...register("name")}
